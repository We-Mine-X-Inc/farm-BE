...
exports.loadContractModel = void 0;
...
function loadContractModel(connection) {
    return (connection.models["Contract"] ||
        connection.model("Contract", contractSchema));
}
exports.loadContractModel = loadContractModel;
