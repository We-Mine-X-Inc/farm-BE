...
class ContractService {
    ...
    findContractById(contractId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if ((0, util_1.isEmpty)(contractId._id.id))
    ...
    createContract(contractData) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const createContractData = yield this.contracts.create(Object.assign({ miner: contractData.miner }, contractData.initialFields));
    ...
    updateContract(request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if ((0, util_1.isEmpty)(request))
                throw new wemine_apis_1.RpcException(400, "You're not contractData");
            const updateContractById = yield this.contracts.findByIdAndUpdate(request.contractId, Object.assign({}, request.mutatedFields));
