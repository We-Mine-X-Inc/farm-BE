...
class MgmtAccountService {
    ...
    findMgmtAccountById(mgmtAccountId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if ((0, util_1.isEmpty)(mgmtAccountId))
                throw new wemine_apis_1.RpcException(400, "You're not mgmtAccountId");
    ...
    createMgmtAccount(mgmtAccountData) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (findMgmtAccount)
                throw new wemine_apis_1.RpcException(409, `You're email ${mgmtAccountData.email} already exists`);
...
exports.default = MgmtAccountService;
