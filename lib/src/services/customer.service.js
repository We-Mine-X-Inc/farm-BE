    ...
    updateCustomerById(customerId, customerData) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (customerData.email) {
                ...
                console.log((0, pretty_format_1.format)(foundCustomer));
                if (foundCustomer && !foundCustomer._id.equals(customerId))
                    throw new wemine_apis_1.RpcException(409, `Your email ${customerData.email} is tied to a different user account than the id you
          provided: ${(0, pretty_format_1.format)(customerId)} ---- ${(0, pretty_format_1.format)(foundCustomer._id)}.`);
            }
