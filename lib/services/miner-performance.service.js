"use strict";
// THIS ENTIRE FILE NEEDS TO BE REVISITED IN ORDER TO IMPROVE THE
...
// import { TimeRange } from "wemine-apis";
// import { PoolWorkerHashRateContribution } from "wemine-apis";
// import PoolRevenueService from "./pool-revenue.service";
// import { Revenue } from "wemine-apis";
// import { revenueDifference } from "../arithmetic/revenue-operations";
...
//     if (!request.minerId) {
//       throw new RpcException(400, "MinerId must be specified.");
//     }
//     if (!request.timeRange) {
//       throw new RpcException(400, "TimeRange must be specified.");
//     }
...
//     if (recordedWorkerContributionsByPool.poolWorkerContributions.length < 1) {
//       // If there are no contributions then exit early.
//     }
...
//# sourceMappingURL=miner-performance.service.js.map